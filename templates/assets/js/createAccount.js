/* =============================================
   CONFIGURACIÓN — cambia esta URL por la de tu servidor Flask
   ============================================= */
const API_URL = "http://localhost:5000/api/asesores";

/* =============================================
   TOGGLE VISIBILIDAD DE CAMPOS (ojo)
   ============================================= */
...
photoInput.addEventListener("change", () => {
  ...
  reader.onload = e => {
    photoBase64 = e.target.result;          // base64 completo
...
/* =============================================
   ENVÍO DEL FORMULARIO A LA API FLASK
   ============================================= */
...
/* =============================================
   ...
   ============================================= */
function resetForm() {
  ["nombres","apellidos","usuario","password","confirmPassword",
